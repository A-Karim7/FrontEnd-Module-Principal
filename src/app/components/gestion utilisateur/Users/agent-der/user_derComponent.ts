...
@Component({
    selector: 'app-users_der',
    template:`<div class="users_der-content">
                    <div class="card">
                        ...
                        <p-dialog [(visible)]="productDialog" [style]="{width: '700px'}" header="Création utilisateur de la {{titre}}"
                            ...
                            <ng-template pTemplate="content">
                                ...
                                <div class="p-formgrid grid">
                                    <div class="field col">
                                        <label for="fonctions">Fonctions <span style="color: red"> *</span></label>
                                ...
                                <div class="p-formgrid grid">
                                    ...
                                    <div class="field col">
                                        ...
                                        <input type="text" pInputText id="reference" [(ngModel)]="utilisateur.reference"/>
                                    </div>
                                </div>
                                <h5>Etat compte</h5>
                            ...
                            <ng-template pTemplate="footer">
                                ...
                                <button pButton pRipple label="Saver" icon="pi pi-check" class="p-button-text" (click)="Verif()"></button>
                            </ng-template>
                        </p-dialog>
                        ...
                        <p-dialog [(visible)]="structDialog" [style]="{width: '700px', height:'400px'}" header="Transfert {{nom}}" [modal]="true" class="p-fluid">
                            <ng-template pTemplate="content">
                                <div class="p-formgrid grid">
                                    <div class="field col">
                            ...
                            <ng-template pTemplate="footer">
                                <button pButton pRipple label="Cancel" icon="pi pi-times" class="p-button-text"
                                        (click)="hideDialog()"></button>
                                <button pButton pRipple label="Transferer" icon="pi pi-check" class="p-button-text" (click)="saveUserprime()"></button>
                            </ng-template>
                        </p-dialog>
                        ...
                        <p-dialog header="Liste des Utilisateurs" [resizable]="false" [modal]="true" [maximizable]="true" appendTo="body" [(visible)]="dialogVisible" [style]="{width: '95vw'}" [contentStyle]="{height: '500px'}">
                            <p-table #dt [value]="utilisateurs" [columns]="cols" responsiveLayout="scroll" [rows]="10" [globalFilterFields]="['prenom_participant','nom_participant','telephone','email','adresse','entreprise']" [rows]="10" [paginator]="true" [rowsPerPageOptions]="[10,20,30]" [showCurrentPageReport]="true" currentPageReportTemplate="Affichage des {first} aux {last}èmes des  {totalRecords} entrées"  selectionMode="multiple" [rowHover]="true" dataKey="id">
                                <ng-template pTemplate="caption">
                                    <div class="flex flex-column md:flex-row md:justify-content-between md:align-items-center">
...
export class User_derComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        console.log(this.sauvegarde.Users_der_Information+' '+this.sauvegarde.Drp_der_Information+' '+this.sauvegarde.Structure_der_Information)
        if(this.sauvegarde.Users_der_Information && this.sauvegarde.Drp_der_Information && this.sauvegarde.Structure_der_Information){

console.log(this.sauvegarde)

        }
        else{
            this.router.navigate(['/Users_drp/Drp']);
        }
        ...
        this.organisationService.getAllUsers().subscribe(
            (data) => {
                this.user = data;
                this.user = this.user.filter(use => use.dg_structure.id === this.sauvegarde.Structure_der_Information.id);
                this.attente=true;
            }
        );
        ...
        this.titre=this.sauvegarde.Structure_der_Information.libelle
    ...
    saveUser() {
        ...
        if (this.utilisateur.nom.trim() && this.utilisateur.prenom.trim() && this.utilisateur.email.trim() && this.utilisateur.matricule.trim()) {
            if (this.utilisateur.id) {
                ...
                this.utilisateur.dg_structure=this.sauvegarde.Structure_der_Information;
                this.http.post<Users>(environment.apiUrl+'/dg_User', this.utilisateur).subscribe(data => {
                        ...
                        if(data!=null){
                            ...
                            this.messageService.add({severity: 'error', summary: 'Successful', detail: 'Utilisateur Non Créé', life: 3000});
    ...
    filterDirectionsbis(event) {
        ...
        this.directioon.sort((a,b) => a.libelle.localeCompare(b.libelle));
        this.direction = this.direction.filter(use => use.id === this.sauvegarde.Structure_der_Information.id);
    ...
    filterFonctions(event) {
        ...
        const query = event.query;
      //  this.fonction = this.fonction.filter(use => use.id == 12 || use.id == 5 || use.id == 13 || use.id == 15 || use.id == 14);
